  ...
  <body>
    <c:choose>
      <c:when test="${param.success == 'serviceDeleted'}">
        <div class="toast toast-success" id="toast">&#10003; Service deactivated successfully.</div>
      </c:when>
      <c:when test="${param.success == 'linkDeleted'}">
        <div class="toast toast-success" id="toast">&#10003; Package-service link removed.</div>
      </c:when>
      <c:when test="${param.error == 'serviceNotFound'}">
        <div class="toast toast-error" id="toast">&#10005; Service not found.</div>
      </c:when>
      <c:when test="${param.error == 'linkNotFound'}">
        <div class="toast toast-error" id="toast">&#10005; Link not found.</div>
      </c:when>
      <c:when test="${param.error == 'invalidId'}">
        <div class="toast toast-error" id="toast">&#10005; Invalid ID supplied.</div>
      </c:when>
    </c:choose>
    ...
    <div class="relative z-10 grid md:grid-cols-[80px_1fr_280px] min-h-screen border-b border-white/10">
      ...
      <main class="pt-14 md:pt-0">
        <div class="dashboard-main">
          ...
          <!-- Bottom CTA -->
          <div class="cta-strip">
            <a href="${pageContext.request.contextPath}/admin/add-service" class="btn btn-gold">+ Add New Service</a>
