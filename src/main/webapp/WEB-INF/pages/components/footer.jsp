  ...
  <div class="container">
    ...
    <div class="container5">
      <div class="container6">
        ...
        <div class="list">
          <div class="item">
            <a href="${pageContext.request.contextPath}/home"><div>Home</div></a>
          </div>
          <div class="item">
            <a href="${pageContext.request.contextPath}/packages"><div>Packages</div></a>
          </div>
          <div class="item">
            <a href="${pageContext.request.contextPath}/about"><div>About</div></a>
          </div>
          <div class="item">
            <a href="${pageContext.request.contextPath}/blog"><div>Blog</div></a>
          </div>
        </div>
      </div>
      ...
      <div class="container7">
        ...
        <div class="list">
          <div class="item">
            <a href="${pageContext.request.contextPath}/login"><div>Login</div></a>
          </div>
          <div class="item">
            <a href="${pageContext.request.contextPath}/register"><div>Register</div></a>
          </div>
        </div>
      </div>
    </div>
