    ...
    >
          ...
          <div class="gap-stack">
            ...
            <div class="bk-card" id="b1">
              ...
              <div class="bk-actions">
                <a href="booking-detail.jsp" class="btn btn-ghost btn-sm"
                  >View Details</a
                >
      ...
      >
        <nav class="space-y-6">
          ...
          <a href="my-bookings.jsp" class="block uppercase active"
            >My Bookings</a
          >
          <a href="book.jsp" class="block uppercase btn-secondary">
            + New Booking</a
          >
          <hr class="hr" />
          <br />
